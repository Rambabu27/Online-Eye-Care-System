...
$dt = date("Y-m-d");
$respat= mysql_query("Select * from appointment where pat_id='$_SESSION[pat_id]' AND app_date='$appdate1' ");
$ctpat = mysql_num_rows($respat);
...
$resdoc= mysql_query("Select * from doctor");
			...
			?>
              ...
              <tr>
               ...
               <div id="txtHint">
				...
				while($rowsa = mysql_fetch_array($resdoc))
				{
