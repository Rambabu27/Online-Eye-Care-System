...
{
	mysql_query("UPDATE  doctor SET  branch_id = '$_POST[bname]',doc_name =  '$_POST[docname]',clinic_name =  '$_POST[cname]', 
...
{
		$resdocrec =  mysql_query("Select * from doctor where doc_id='$_SESSION[doc_id]'");
}
else
{
	$resdocrec =  mysql_query("Select * from doctor where doc_id='$_GET[docid]'");
}
	

$rowsdoc = mysql_fetch_array($resdocrec);
            ...
            <table width="595" border="0">
              ...
              <tr>
                <td height="45"><label for="contact" class="left">Branch Name:</label></td>
                 <?php
           	$resdocreca =  mysql_query("Select * from branch");
			?>
                <td><select name="bname" id="bname">
                <?php
			while($rowsa = mysql_fetch_array($resdocreca))
			{
