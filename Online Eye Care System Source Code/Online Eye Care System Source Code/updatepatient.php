...
if(isset($_POST[submit]))
{
	...
	mysql_query("UPDATE  patient SET  pat_name =  '$_POST[name]', dob = '$dob',email_id = '$_POST[emailid]', contact= '$_POST[contact]',address='$_POST[address]' WHERE  pat_id ='$_POST[patid]'");
...
if(isset($_GET[patid]))
{
	$respatrec =  mysql_query("Select * from patient where pat_id='$_GET[patid]'");
}
else
{
$respatrec =  mysql_query("Select * from patient where pat_id='$_SESSION[pat_id]'");
}
$rowspat = mysql_fetch_array($respatrec);
