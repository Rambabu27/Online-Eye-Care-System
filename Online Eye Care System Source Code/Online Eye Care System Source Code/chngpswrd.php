...
if(isset($_POST["submit"]))
{
		...
		{
			mysql_query("UPDATE patient SET password='$_POST[nwpswrd]' WHERE email_id ='$_POST[loginid]' and password='$_POST[oldpswrd]'");
		...
		{
			mysql_query("UPDATE admin SET password='$_POST[nwpswrd]' WHERE login_id ='$_POST[loginid]' and password='$_POST[oldpswrd]'");
			if(mysql_affected_rows() ==1)
			{
		...
		{
			mysql_query("UPDATE doctor SET password='$_POST[password]' WHERE login_id ='$_POST[loginid]' and password='$_POST[oldpswrd]'");
			if(mysql_affected_rows() ==1)
			{
				$msgpass="<b><font color='#009900'>Password Changed successfully</font></b>";
			}
