...
{
mysql_query("UPDATE patient SET password='$_POST[password]' WHERE pat_id='$_POST[pat_id]' ");
	if(mysql_affected_rows() == 1)
	{
		$passwordupdate= 1;
	}
//$result1 = mysql_query("SELECT * FROM patient WHERE pat_id='$_POST[pat_id]' AND password='$_POST[cont_no]'");
	
//echo.mysql_num_rows($result);
}
else
{
	$result = mysql_query("SELECT * FROM patient WHERE pat_id='$_POST[pat_id]' AND contact='$_POST[cont_no]'");
}
?>
