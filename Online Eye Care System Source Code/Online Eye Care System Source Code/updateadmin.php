...
{
	mysql_query("UPDATE  admin SET  branch_id =  '$_POST[bname]',admin_name =  '$_POST[aname]',login_id =  '$_POST[loginid]',email_id =  '$_POST[emailid]' WHERE  admin_id ='$_SESSION[admin_id]'");
...
{
	$resadminrec =  mysql_query("Select * from admin where admin_id='$_GET[adminid]'");
}
else
{
$resadminrec =  mysql_query("Select * from admin where admin_id='$_SESSION[admin_id]'");
}
$rowsadmin = mysql_fetch_array($resadminrec);
	...
	if(document.form1.bname.value=="")
	{
        ...
        <table width="595" border="0">
          ...
          <tr>
            ...
            <td>
            <?php
           	$resadminreca =  mysql_query("Select * from branch");
			?>
            <select name="bname" id="bname">
            <option value="">Select</option>
            <?php
			while($rowsa = mysql_fetch_array($resadminreca))
			{
